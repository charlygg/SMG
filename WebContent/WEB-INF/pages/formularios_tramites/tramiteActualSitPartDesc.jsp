...
$("#idtramite").change(
		function() {
			$.getJSON(
				'consultaTramite_actualizacion_situacion_particular_descarga?idtramite='
				+ $("#idtramite").val(),
							function(beanDatos) {
...
$(document).ready(function() {
		$.validator.setDefaults({submitHandler: function() { transaccionDatosRetornoID( 'registerTramite_actualizacion_situa_partdes', 'formulario', true, "exito()", "fallo()");}});
		$('#formulario').validate();
		comboListaTramite();
		comboEstatus();
	});
...
$('#idtramite').empty();
$.getJSON('listacomboTramite_actualizacion_situacion_particular_descarga?rol_usuario='
	...
	function exito(){
// 		mensajeriaAlertas('Exito', 'En Alta de Tramite Actualización de Situación Particular de Descarga');
		comboListaTramite();
	...
	function fallo(){
		mensajeriaAlertas('Error', 'En Alta de Tramite Actualización de Situación Particular de Descarga');
		$('#idtramite').eq(1).prop('selected', true);
		$('#idempresa').eq(0).prop(
				'selected', true);
		$("#idestablecimiento")
	...
	<div class="col-lg-12">
		<div class="box box-success">
			<div class="box-header with-border">
				<h3 class="box-title">Actualización de Situación Particular de
					Descarga.</h3>
			</div>
			...
			<div class="box-body">
				...
				<input type="hidden" id="areaNumOficio" value="CD"> <input
					...
					value="Actualización de Situación Particular de Descarga">
				<input type="hidden" id="tipoTramiteNumOficio" value="23">
				<%@ include
				...
				<form id="formulario" role="form">
					<c:choose>
						<c:when test="${empty data}">
							...
							<div class="input-group">
								<span class="input-group-addon">Nombre del propietario
									y/o representante legal</span> <input type="text" maxlength="100"
									type="text" class="form-control" id="nomrepresentante"
							...
							<div class="input-group">
								<span class="input-group-addon">Teléfono :</span> <input
									type="text" class="form-control" id="telefonodes"
									name="telefonodes">
							</div>
							<br>
							<div class="input-group">
								<span class="input-group-addon">Entre Calles:</span> <input
									type="text" class="form-control" id="entrecalles"
									name="entrecalles">
							</div>
							<br>
							<div class="input-group">
							...
							<div class="input-group">
								<span class="input-group-addon">Servicios de Agua y
									Drenaje de Mty. :&nbsp; &nbsp; Contrato:</span> <input type="text"
									maxlength="100" class="form-control" id="servicio"
									name="servicio">
							</div>
							<br>
							<div class="input-group">
								<span class="input-group-addon">Comisión Nacional del
									Agua:&nbsp; &nbsp; N° de concesión:</span> <input type="text"
									maxlength="100" class="form-control" id="concesion"
									name="concesion">
							</div>
							<br>
							<div class="input-group">
								<span class="input-group-addon">Residual Planta:&nbsp;
									&nbsp; N° de contrato:</span> <input type="text" maxlength="100"
							...
							<div class="input-group">
								<span class="input-group-addon">Oficio No:</span> <input
									type="text" class="form-control" id="oficio" name="oficio">
							</div>
							<br>
							<div class="input-group">
							...
							<div class="input-group">
								<span class="input-group-addon">(Especificar Horario):</span> <input
									type="text" class="form-control" id="horadescarga"
									name="horadescarga">
							</div>
							<br>
							<div class="input-group">
							...
							<div class="input-group">
								<span class="input-group-addon">(Especificar Horario):</span> <input
									type="text" class="form-control" id="horadescargasda"
									name="horadescargasda">
							</div>
							<br>
							<div class="input-group">
							...
							<div class="input-group">
								<span class="input-group-addon">(Especificar Horario):</span> <input
									type="text" class="form-control" id="horadescargatra"
									name="horadescargatra">
							</div>
							<br>
							<div class="input-group">
								<span class="input-group-addon">Proviene de áreas:</span>
							...
							<div class="input-group">
								<span class="input-group-addon">(Especificar Horario):</span> <input
									type="text" class="form-control" id="horadescargacta"
									name="horadescargacta">
							</div>
							<br>
							<div class="input-group">
								<span class="input-group-addon">Proviene de áreas:</span>
							...
							<div class="input-group">
								<span class="input-group-addon">Fecha de Alta de
									Registro:</span> <input type="text" maxlength="100"
						...
						<c:otherwise>
							<div class="input-group">
								<span class="input-group-addon">Número de Folio</span> <input
									type="text" class="form-control" id="nfolio" name="nfolio"
									required value="${ data.nfolio }">
							</div>
							<br>
							<div class="box box-success">
								<div class="box-header with-border">
							...
							<div class="input-group">
								<span class="input-group-addon">Teléfono :</span> <input
									type="text" class="form-control" id="telefonodes"
									name="telefonodes" value="${ data.telefonodes }">
							</div>
							<br>
							<div class="input-group">
								<span class="input-group-addon">Entre Calles:</span> <input
									type="text" class="form-control" id="entrecalles"
									name="entrecalles" value="${ data.entrecalles }">
							</div>
							<br>
							<div class="input-group">
								<span class="input-group-addon">Correo eléctronico :</span> <input
							...
							<div class="input-group">
								<span class="input-group-addon">(Especificar Horario):</span> <input
									type="text" class="form-control" id="horadescarga"
									name="horadescarga" value="${ data.horadescarga }">
							</div>
							<br>
							<div class="input-group">
								<span class="input-group-addon">Proviene de áreas:</span>
							...
							<div class="input-group">
								<span class="input-group-addon">(Especificar Horario):</span> <input
									type="text" class="form-control" id="horadescargasda"
									name="horadescargasda" value="${ data.horadescargasda }">
							</div>
							<br>
							<div class="input-group">
								<span class="input-group-addon">Proviene de áreas:</span><br>
							...
							<div class="input-group">
								<span class="input-group-addon">(Especificar Horario):</span> <input
									type="text" class="form-control" id="horadescargatra"
									name="horadescargatra" value="${ data.horadescargatra }">
							</div>
							<br>
							<div class="input-group">
								<span class="input-group-addon">Proviene de áreas:</span>
							...
							<div class="input-group">
								<span class="input-group-addon">(Especificar Horario):</span> <input
									type="text" class="form-control" id="horadescargacta"
									name="horadescargacta" value="${ data.horadescargacta }">
							</div>
							<br>
							<div class="input-group">
								<span class="input-group-addon">Proviene de áreas:</span>
