...
@Entity
@Table(name = "tramite_informacion")
public class Tramite_informacion {
	
	@Id
	@GeneratedValue
	@Column(name = "idtramite_informacion")
	private int idtramite_informacion;
	...
	public int getIdtramite_informacion() {
		return idtramite_informacion;
	}

	public void setIdtramite_informacion(int idtramite_informacion) {
		this.idtramite_informacion = idtramite_informacion;
	}
