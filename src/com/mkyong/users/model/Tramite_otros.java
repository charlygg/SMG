...
@Entity
@Table(name = "tramite_otros")
public class Tramite_otros {
	
	@Id
	@GeneratedValue
	@Column(name = "idtramite_otros")
	private int idtramite_otros;
	...
	public int getIdtramite_otros() {
		return idtramite_otros;
	}

	public void setIdtramite_otros(int idtramite_otros) {
		this.idtramite_otros = idtramite_otros;
	}
