...
@Entity
@Table(name = "tramite_baja_permisos")
public class Tramite_baja_permisos {
	
	@Id
	@GeneratedValue
	@Column(name = "idtramite_baja_permisos")
	private int idtramite_baja_permisos;
	...
	public int getIdtramite_baja_permisos() {
		return idtramite_baja_permisos;
	}

	public void setIdtramite_baja_permisos(int idtramite_baja_permisos) {
		this.idtramite_baja_permisos = idtramite_baja_permisos;
	}
