...
@Entity
@Table(name = "tramite_consultas")
public class Tramite_consultas {

	@Id
	@GeneratedValue
	@Column(name = "idtramite_consultas")
	private int idtramite_consultas;
	...
	public int getIdtramite_consultas() {
		return idtramite_consultas;
	}

	public void setIdtramite_consultas(int idtramite_consultas) {
		this.idtramite_consultas = idtramite_consultas;
	}
