...
@Entity
@Table(name = "tramite_actualizacion_tranps")
public class Tramite_actualizacion_tranps {
	
	@Id
	@GeneratedValue
	@Column(name = "idtramite_actualizacion_tranps")
	private int idtramite_actualizacion_tranps;
	...
	public int getIdtramite_actualizacion_tranps() {
		return idtramite_actualizacion_tranps;
	}

	public void setIdtramite_actualizacion_tranps(int idtramite_actualizacion_tranps) {
		this.idtramite_actualizacion_tranps = idtramite_actualizacion_tranps;
	}
