...
@Entity
@Table(name = "tramite_cambio_razon_social")
public class Tramite_cambio_razon_social {
	
	@Id
	@GeneratedValue
	@Column(name = "idtramite_cambio_razon_social")
	private int idtramite_cambio_razon_social;
	
	@Column(name = "nueva_razon")
	private String nueva_razon;
	...
	public int getIdtramite_cambio_razon_social() {
		return idtramite_cambio_razon_social;
	}

	public void setIdtramite_cambio_razon_social(int idtramite_cambio_razon_social) {
		this.idtramite_cambio_razon_social = idtramite_cambio_razon_social;
	}

	public String getNueva_razon() {
		return nueva_razon;
	}

	public void setNueva_razon(String nueva_razon) {
		this.nueva_razon = nueva_razon;
	}
