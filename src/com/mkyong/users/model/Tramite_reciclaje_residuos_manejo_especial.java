...
@Entity
@Table(name = "tramite_reciclaje_residuos_manejo_especial")
public class Tramite_reciclaje_residuos_manejo_especial {

	@Id
	@GeneratedValue
	@Column(name = "idtramite_reciclaje_residuos_manejo_especial")
	private int idtramite_reciclaje_residuos_manejo_especial;
	...
	@Column(name = "descripcion_proceso_residuo")
	private String descripcion_proceso_residuo;
	
	@Column(name = "productos_obtenidos")
	private String productos_obtenidos;
	...
	public int getIdtramite_reciclaje_residuos_manejo_especial() {
		return idtramite_reciclaje_residuos_manejo_especial;
	}

	public void setIdtramite_reciclaje_residuos_manejo_especial(
			int idtramite_reciclaje_residuos_manejo_especial) {
		this.idtramite_reciclaje_residuos_manejo_especial = idtramite_reciclaje_residuos_manejo_especial;
	}
	...
	public String getDescripcion_proceso_residuo() {
		return descripcion_proceso_residuo;
	}

	public void setDescripcion_proceso_residuo(String descripcion_proceso_residuo) {
		this.descripcion_proceso_residuo = descripcion_proceso_residuo;
	}

	public String getProductos_obtenidos() {
		return productos_obtenidos;
	}

	public void setProductos_obtenidos(String productos_obtenidos) {
