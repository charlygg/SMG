...
@Entity
@Table(name = "tramite_impacto_ambiental")
public class Tramite_impacto_ambiental {

	@Id
	@GeneratedValue
	@Column(name = "idtramite_impacto_ambiental")
	private int idtramite_impacto_ambiental;
	...
	public int getIdtramite_impacto_ambiental() {
		return idtramite_impacto_ambiental;
	}

	public void setIdtramite_impacto_ambiental(int idtramite_impacto_ambiental) {
		this.idtramite_impacto_ambiental = idtramite_impacto_ambiental;
	}
