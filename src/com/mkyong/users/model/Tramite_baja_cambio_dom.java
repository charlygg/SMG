...
@Entity
@Table(name = "tramite_baja_cambio_dom")
public class Tramite_baja_cambio_dom {
	
	@Id
	@GeneratedValue
	@Column(name = "idtramite_baja_cambio_dom")
	private int idtramite_baja_cambio_dom;
	...
	public int getIdtramite_baja_cambio_dom() {
		return idtramite_baja_cambio_dom;
	}

	public void setIdtramite_baja_cambio_dom(int idtramite_baja_cambio_dom) {
		this.idtramite_baja_cambio_dom = idtramite_baja_cambio_dom;
	}
