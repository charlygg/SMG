...
@Entity
@Table(name = "tramite_evaluacion_impacto_ambiental")
public class Tramite_evaluacion_impacto_ambiental {

	@Id
	@GeneratedValue
	@Column(name = "idtramite_evaluacion_impacto_ambiental")
	private int idtramite_evaluacion_impacto_ambiental;
	...
	public int getIdtramite_evaluacion_impacto_ambiental() {
		return idtramite_evaluacion_impacto_ambiental;
	}

	public void setIdtramite_evaluacion_impacto_ambiental(
			int idtramite_evaluacion_impacto_ambiental) {
		this.idtramite_evaluacion_impacto_ambiental = idtramite_evaluacion_impacto_ambiental;
	}
