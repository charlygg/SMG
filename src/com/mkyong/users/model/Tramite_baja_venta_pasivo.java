...
@Entity
@Table(name = "tramite_baja_venta_pasivo")
public class Tramite_baja_venta_pasivo {
	
	@Id
	@GeneratedValue
	@Column(name = "idtramite_baja_venta_pasivo")
	private int idtramite_baja_venta_pasivo;
	...
	public int getIdtramite_baja_venta_pasivo() {
		return idtramite_baja_venta_pasivo;
	}

	public void setIdtramite_baja_venta_pasivo(int idtramite_baja_venta_pasivo) {
		this.idtramite_baja_venta_pasivo = idtramite_baja_venta_pasivo;
	}
