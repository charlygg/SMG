...
@Entity
@Table(name = "tramite_ubiopermaintescsitdisfiresidprocons")
public class Tramite_UbiOperMaIntEscSitDisFiResidProCons {
	...
	@Column(name = "usprteviutesc")
	private String usprteviutesc;
	
	
	@Column(name = "carecomademades")
	private String carecomademades;
	...
	public String getUsprteviutesc() {
		return usprteviutesc;
	}

	public void setUsprteviutesc(String usprteviutesc) {
		this.usprteviutesc = usprteviutesc;
	}

	public String getCarecomademades() {
		return carecomademades;
	}

	public void setCarecomademades(String carecomademades) {
		this.carecomademades = carecomademades;
	}
