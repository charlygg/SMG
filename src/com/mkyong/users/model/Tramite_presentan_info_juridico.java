...
@Entity
@Table(name="tramite_presentan_info_juridico")
public class Tramite_presentan_info_juridico {
	...
	public Tramite_presentan_info_juridico() {	}

	public Tramite_presentan_info_juridico(int idtramite_residuos, int idempresa, int idestablecimiento, String asunto,
