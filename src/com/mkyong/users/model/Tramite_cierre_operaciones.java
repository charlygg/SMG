...
@Entity
@Table(name = "tramite_cierre_operaciones")
public class Tramite_cierre_operaciones {

	@Id
	@GeneratedValue
	@Column(name = "idtramite_cierre_operaciones")
	private int idtramite_cierre_operaciones;
	...
	public int getIdtramite_cierre_operaciones() {
		return idtramite_cierre_operaciones;
	}

	public void setIdtramite_cierre_operaciones(int idtramite_cierre_operaciones) {
		this.idtramite_cierre_operaciones = idtramite_cierre_operaciones;
	}
