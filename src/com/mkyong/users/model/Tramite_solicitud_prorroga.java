...
@Entity
@Table(name = "tramite_solicitud_prorroga")
public class Tramite_solicitud_prorroga {

	@Id
	@GeneratedValue
	@Column(name = "idtramite_solicitud_prorroga")
	private int idtramite_solicitud_prorroga;
	...
	public int getIdtramite_solicitud_prorroga() {
		return idtramite_solicitud_prorroga;
	}

	public void setIdtramite_solicitud_prorroga(int idtramite_solicitud_prorroga) {
		this.idtramite_solicitud_prorroga = idtramite_solicitud_prorroga;
	}
