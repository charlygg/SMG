...
@Entity
@Table(name = "tramite_solicitud_copias")
public class Tramite_solicitud_copias {
	@Id
	@GeneratedValue
	@Column(name = "idtramite_solicitud_copias")
	private int idtramite_solicitud_copias;
	...
	public int getIdtramite_solicitud_copias() {
		return idtramite_solicitud_copias;
	}

	public void setIdtramite_solicitud_copias(int idtramite_solicitud_copias) {
		this.idtramite_solicitud_copias = idtramite_solicitud_copias;
	}
