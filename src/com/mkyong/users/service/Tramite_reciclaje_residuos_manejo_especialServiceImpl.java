...
import com.mkyong.users.dao.Tramite_reciclaje_residuos_manejo_especialDao;
import com.mkyong.users.model.Tramite_reciclaje_residuos_manejo_especial;


@Service
@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
public class Tramite_reciclaje_residuos_manejo_especialServiceImpl implements Tramite_reciclaje_residuos_manejo_especialService {
	
	@Autowired
	Tramite_reciclaje_residuos_manejo_especialDao tramite_ubiopermaintrellsaniconfnormofimexDao;
