...
@Repository("tramite_impacto_ambientalDao")
public class Tramite_impacto_ambientalDaoImpl implements Tramite_impacto_ambientalDao {
	...
	public List<Tramite_impacto_ambiental> lista() {
		...
		List<Tramite_impacto_ambiental> users = sessionFactory.getCurrentSession().createCriteria(Tramite_impacto_ambiental.class).list();
	...
	public List<Tramite_impacto_ambiental> lista(String rol) {
		List<Tramite_impacto_ambiental> list = new ArrayList<Tramite_impacto_ambiental>();
		if(rol.contentEquals("ROLE_RECEP")){
			list = sessionFactory.getCurrentSession().createCriteria(Tramite_impacto_ambiental.class)
	...
	public Tramite_impacto_ambiental consulta(Tramite_impacto_ambiental nuevo, String rol){
		List<Tramite_impacto_ambiental> list = new ArrayList<Tramite_impacto_ambiental>();
		Tramite_impacto_ambiental resultado = null;
		list = sessionFactory.getCurrentSession().createCriteria(Tramite_impacto_ambiental.class).add(Restrictions.eq("tramite_impacto_ambiental", nuevo.getIdtramite_impacto_ambiental())).list();
	...
	public List<WrapperTramite> listaTramitesByZona(String municipio, String colonia) {
		...
		List<WrapperTramite> resultWithAliasedBean = sessionFactory.getCurrentSession().createSQLQuery(
				"Select tramite_impacto_ambiental.idtramite_impacto_ambiental as idtramite,'cambio razon social' as tipo,catalogo_perfilempresa.nombreEmpresa as nombre_empresa"+
				" from tramite_impacto_ambiental "+
				" left join  catalogo_perfilestablecimiento"+ 
				" on catalogo_perfilestablecimiento.idcatalogo_perfilestablecimiento = tramite_impacto_ambiental.catalogo_perfilestablecimiento_idcatalogo_perfilestablecimiento"+
